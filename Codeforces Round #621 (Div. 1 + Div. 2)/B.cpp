...
long long int num1,num2,test, arr[100005],val=9999999999,val2=9999999999;
cin>>test;
while(test--){
        val=val2;
    cin>>num1>>num2;
    FOR(i,0,num1){
    cin>>arr[i];
    int xx=gcd(arr[i],num2);
//   cout<<xx<<endl;
    if(xx>1 && xx<val)val=xx;

    }
    if(val==val2)cout<<num1<<endl;
else if(val==num2)cout<<"1\n";
    else cout<<val<<endl;
}
