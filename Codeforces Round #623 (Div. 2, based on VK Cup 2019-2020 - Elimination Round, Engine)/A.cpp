...
long long int test, num1,num2,num3,num4;
long long int val;
cin>>test;
while(test--){
     cin>>num3>>num4>>num1>>num2;
     long long int xx=(num1)*(num4);
    long long int xx2=(num3- num1-1)*(num4);
     long long int yy=(num3*num2);
     long long int yy2=(num3*(num4-num2-1));
     val=max(xx,xx2);
     val=max(val,yy);
     val=max(val,yy2);
     cout<<val<<endl;
